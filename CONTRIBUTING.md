...
Ready to contribute? Here's how to set up `pycounts-tat` for local development.

1. Download a copy of `pycounts-tat` locally.
2. Install `pycounts-tat` using `poetry`:
